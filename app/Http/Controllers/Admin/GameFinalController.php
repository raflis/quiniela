...
class GameFinalController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.games_final.index', compact('games'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.games_final.create', compact('teams'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $messages=[
            ...
            'phase.required' => 'Ingrese la fase del partido',
        ];
        ...
        if($validator->fails()):
            ...
            return redirect()->route('games_final.index')->with('message', 'Creado con éxito.')->with('typealert', 'success');
        endif;
    }
    ...
    public function edit($id)
    {
        $teams = Team::orderBy('name', 'ASC')->pluck('name', 'id');
        $game = Game::find($id);
        return view('admin.games_final.edit', compact('game', 'teams'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($validator->fails()):
            ...
            return redirect()->route('games_final.index')->with('message', 'Actualizado con éxito.')->with('typealert', 'success');
        endif;
    }
