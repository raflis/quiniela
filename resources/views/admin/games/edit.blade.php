        ...
        <div class="row layout-body">
            <div class="col-sm-12">
                <div class="card shadow">
                    ...
                    {!! Form::model($game, ['route' => ['games.update', $game->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) !!}
            ...
            <div class="col-sm-12 my-4">
                ...
                <a class="btn btn-danger py-2 px-3" href="{{ route('games.index') }}">Atrás</a>
                {!! Form::close() !!}
            </div>
        </div>
