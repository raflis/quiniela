                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: inline-flex">
                                        <a class="btn btn-primary text-white btn-sm mr-1" href="{{ route('games.edit', $item->id) }}">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-center">
            ...
            {!! Form::open(['route' => ['games.destroy', ''], 'method' => 'DELETE', 'id' => 'form-eliminar']) !!}
