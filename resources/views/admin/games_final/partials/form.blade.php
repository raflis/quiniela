<div class="form-group col-sm-3">
  {{ Form::label('phase', 'Fase del partido:') }} <code>*</code>
  {{ Form::select('phase', phases(), null, ['class' => 'custom-select', 'placeholder' => 'Seleccione la fase del partido', 'required']) }}
</div>
...
@if (Route::currentRouteName()=="games_final.edit")
